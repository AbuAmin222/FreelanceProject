...
<head>
    ...
    <title>Freelancer Site - Dark-Mode</title>
        <style>
        .btn-logout {
            border: none;
            /* إزالة الحدود */
            outline: none;
            /* إزالة الـ outline الافتراضي */
            padding: 0.6rem 1rem;
            /* مساحة داخلية مريحة */
            background: #111827;
            background: #fff;
        ...
        /* بديل آمن للوصولية بدل outline الافتراضي */
...
<body>
    ...
    <div class="wrapper">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                ...
                                <li>
                                    <form id="logout-form" action="{{ route($guard . '.logout') }}" method="post">
                                        @csrf
                                        <div class="d-flex align-items-center">
                                            <button type="submit" class="btn-logout btn-full">Logout</button>
                                        </div>
                                    </form>
                                </li>
                            </ul>
        ...
        <!--start sidebar -->
        @include('Dashboard.Sidebar.sidebarDarkDash')
        <!--end sidebar -->
