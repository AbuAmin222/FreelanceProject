    ...
    <section class="register-section">
        <div class="register-container">
            <div class="register-form-container">
                ...
                <form enctype="multipart/form-data" method="POST" action="{{ route('register.submit') }}" id="registerForm">
                    @csrf
                        ...
                        <div class="form-step active" id="step1">
                            <div class="form-group">
                                ...
                                <div class="account-type">
                                    <input  value="client" type="radio" name="account_type" id="client"  checked>
                                    <label for="client">
                                    ...
                                    <input value="freelancer" type="radio" name="account_type" id="freelancer" >
